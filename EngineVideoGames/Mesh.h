...
{
public:
	Vertex(const glm::vec3& pos, const glm::vec2& texCoord, const glm::vec3& normal, const glm::vec3& color,const glm::vec3& weight)
	{
		this->pos = pos;
	...
	glm::vec3* getweights() { return &weight; }
...
{
private:
	bool checkCollision(glm::mat4 myMat, BoundingBox b1, BoundingBox b2, glm::mat4 otherMat, glm::mat4 b1scale, glm::mat4 b2scale); // static
...
public:
	...
	void updateValues(glm::mat4 trans, glm::mat4 scale);
	glm::vec3 newCenter;
	glm::vec3 newsize;
	glm::vec3 newxInit;      // x axis of the box. default value (1,0,0)		  
	glm::vec3 newyInit;      // y axis of the box. default value (0,1,0)		 
	glm::vec3 newzInit;	  // z axis of the box. default value (0,0,1)
	...
	bool checkCollision(glm::mat4 myMat,BoundingBox other,glm::mat4 otherMat, glm::mat4 b1scale, glm::mat4 b2scale);
};
